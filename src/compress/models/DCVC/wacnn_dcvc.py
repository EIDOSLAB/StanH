...
from compress.models.utils import conv,deconv,update_registered_buffers
...
from compress.models.base import CompressionModel, CompressionModelBaseline
...
class WACNN_DCVC(CompressionModelBaseline):
    """CNN based model"""
    ...
    def __init__(self,
                ...
                M=320,
                anchor_num=4,
                lmbda_list = [0.0018,0.0036,0.009,0.025],
                **kwargs):
        ...
        self.y_prior_fusion = nn.Sequential(
            ...
            nn.LeakyReLU(0.2),
            nn.Conv2d(224, 288, 3, stride=1, padding=1),
            nn.LeakyReLU(0.2),
            nn.Conv2d(288,320, 3, stride=1, padding=1)
        )
    ...
    def forward(self, x, index = 0, q_scale=None):

        q_scale = self.q_scale[index] if q_scale is None else q_scale
        ...
        q_space = self.y_prior_fusion(z_hat)

        print("-----> PRINT ",q_space.shape)

        y_slices = y.chunk(self.num_slices, 1)
        q_space_slices = q_space.chunk(self.num_slices,1)
        y_hat_slices = []
        y_likelihood = []
        ...
        for slice_index, y_slice in enumerate(y_slices):
            ...
            y_slice = y_slice/q_space_slices[slice_index]
            ...
            y_hat_slice = y_hat_slice*q_space_slices[slice_index]
    ...
    def decompress(self, strings, shape, q_scale):
        ...
        for slice_index in range(self.num_slices):
            ...
            y_hat_slices = y_hat_slices*q_space_slices[slice_index]
